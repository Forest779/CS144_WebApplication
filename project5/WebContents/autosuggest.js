...
AutoSuggestControl.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //alert("keyup"+this.textbox.value);
...
AutoSuggestControl.prototype.typeAhead = function (sSuggestion /*:String*/) {
    ...
    if (this.textbox.createTextRange || this.textbox.setSelectionRange){
        ...
        if(sSuggestion.indexOf(this.textbox.value) != -1) {
    ...
    if (sTextboxValue.length > 0) {
        ...
        this.xmlHttp.onreadystatechange = function() {
            if (oThis.xmlHttp.readyState == 4) {
                ...
                oThis.autosuggest(aSuggestions, bTypeAhead);
            }
        }
...
// AutoSuggestControl.prototype.googleSuggest = function () {
//     //alert("test");
...
//         alert("test4");
//         var aSuggestions = ["one","two","three"];
...
//             aSuggestions.push(text);
//         }
//         this.autosuggest(aSuggestions, true);
//     }
// };
